...
def generate_validation_plan(
    *,
    ...
    return {
        ...
        "metadata": planned.metadata.model_dump(mode="json"),
...
def execute_pipeline(
    *,
    ...
    recorder.record(
        ...
        live_model_call=planned.metadata.live_model_call,
        generated_by=planned.plan.generated_by,
    )
    ...
    return {
        "run_id": recorder.run_id,
        "plan": planned.plan.model_dump(mode="json"),
        "planner": planned.metadata.model_dump(mode="json"),
        "eval": eval_result.to_dict(),
...
def main() -> None:
    ...
    if args.command == "plan":
        ...
        print(
            ...
            f"gate={result['execution_gate']['status']}"
        )
        return
